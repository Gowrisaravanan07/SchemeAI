...
import { INDIAN_STATES, CATEGORIES, OCCUPATIONS } from '../../data/indianStates';
...
const OnboardingModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const availableDistricts = INDIAN_STATES[formData.state] || [];
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                >
                  {/* Agriculture & Allied */}
                  <optgroup label="Agriculture & Allied">
                    <option>Farmer</option>
                    <option>Agricultural Labourer</option>
                    <option>Fisherman</option>
                    <option>Animal Husbandry Worker</option>
                    <option>Dairy Farmer</option>
                    <option>Horticulturist</option>
                    <option>Poultry Farmer</option>
                    <option>Sericulture Worker</option>
                  </optgroup>
                  {/* Labour & Workforce */}
                  <optgroup label="Labour & Workforce">
                    <option>Construction Worker</option>
                    <option>Domestic Worker</option>
                    <option>Migrant Worker</option>
                    <option>Contract / Daily Wage Worker</option>
                    <option>MGNREGA Worker</option>
                    <option>Sanitation Worker</option>
                    <option>Beedi / Cigar Worker</option>
                  </optgroup>
                  {/* Business & Self-Employed */}
                  <optgroup label="Business & Self-Employed">
                    <option>Small Business Owner</option>
                    <option>Street Vendor / Hawker</option>
                    <option>Micro Entrepreneur</option>
                    <option>Trader / Shopkeeper</option>
                    <option>Auto / Taxi Driver</option>
                    <option>Self-Employed Professional</option>
                  </optgroup>
                  {/* Artisans & Craftsmen */}
                  <optgroup label="Artisans & Craftsmen">
                    <option>Artisan / Craftsperson</option>
                    <option>Handloom Weaver</option>
                    <option>Khadi Worker</option>
                    <option>Potter / Ceramics Worker</option>
                    <option>Blacksmith / Goldsmith</option>
                  ...
                  <optgroup label="Government & Services">
                    ...
                    <option>Ex-Serviceman / Defence</option>
                  ...
                  <optgroup label="Special Categories">
                    ...
                    <option>Widow / Single Parent</option>
                    <option>Transgender</option>
                    <option>Unemployed / Job Seeker</option>
                    <option>Homeless / BPL Family</option>
                  </optgroup>
                </select>
              </div>
            </div>
            <div className="space-y-2">
              <label className="text-xs font-bold text-indian-navy/60 ml-1">State</label>
              <div className="relative group">
                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-indian-saffron transition-colors" />
                <select 
                  name="state"
                  ...
                  onChange={(e) => {
                    ...
                    setFormData({
                      ...formData,
                      state: newState,
                      district: INDIAN_STATES[newState] ? INDIAN_STATES[newState][0] : ''
                    });
                  }}
                  className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-white border border-black/5 focus:border-indian-saffron outline-none transition-all font-medium appearance-none text-sm"
                >
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-indian-navy/60 ml-1">District</label>
              <div className="relative group">
                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-indian-saffron transition-colors" />
                <select 
                  name="district"
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-indian-navy/60 ml-1">Category</label>
              <div className="relative group">
