      ...
      <div className="bg-indian-navy rounded-[3rem] overflow-hidden grid grid-cols-1 lg:grid-cols-2 items-center text-white">
        <div className="p-10 md:p-20">
          ...
          <p className="text-slate-300 text-lg mb-10 leading-relaxed">
            CivicAssist AI uses Law from a citizen's perspective, to ensure no citizen of India is left behind because of a language barrier or complex paperwork. We are building the world's most inclusive AI layer for governance.
          </p>
