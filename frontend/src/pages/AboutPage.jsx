      ...
      <main className="flex-1 py-16 px-6 md:px-12 mt-16 max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-5 duration-700">
          <h1 className="text-4xl md:text-6xl font-black text-indian-navy tracking-tight mb-6">
            About <img src={logo} alt="CivicAssist AI" className="w-120 h-30 inline-block mb-6" />
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-indian-navy/70 leading-relaxed mb-6">
                Navigating government benefits can be complex and time-consuming. We built CivicAssist AI to bridge the gap between citizens and the resources they deserve. 
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {[
            ...
            },
            {
              ...
              desc: "CivicAssist AI works in the background, continuously tracking your status and alerting you of new opportunities.",
